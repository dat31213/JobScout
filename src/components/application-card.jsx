  ...
  return (
    <Card>
        ...
        <CardContent className="flex flex-col gap-4 flex-1">
            <div className="flex flex-col md:flex-row justify-between">
                <div className="flex gap-2 items-center"> 
                    <BriefcaseBusiness size={15}/> {application?.experience} năm kinh nghiệm
                </div>
                <div className="flex gap-2 items-center"> 
                    <School size={15}/> {application?.education}
                </div>
                <div className="flex gap-2 items-center"> 
                    <Boxes size={15}/> Kỹ năng: {application?.skills}
                </div>
            </div>
            <hr/>
        </CardContent>
        <CardFooter className="flex justify-between">
            ...
            <SelectContent>
                <SelectItem value={"applied"}>Xác nhận</SelectItem>
                <SelectItem value={"interviewing"}>Phỏng vấn</SelectItem>
                <SelectItem value={"hired"}>Trúng tuyển</SelectItem>
